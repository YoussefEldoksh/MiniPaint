...
public class Square implements Shape{
    ...
    public void setProperties(HashMap<String, Double> properties) {
        this.properties.put("Side",properties.get("Side"));
    ...
    public void draw(Graphics canvas) {
        ...
        int side = (int) Math.round(getProperties().get("Side"));
    ...
    public String toString() {
        String s =  "Square" + "," + color.getRed()+ ","+ color.getGreen() + ","+color.getBlue() +"," + position.x +"," + position.y +"," + properties.get("Side");
